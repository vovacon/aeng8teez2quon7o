...
## Организация CI/CD в проекте

Проект использует следующую архитектуру workflows:

### 🧪 **tests.yml** - Основной пайплайн тестирования
- **Базовая безопасность:** поиск секретов, IP-адресов
- **Качество кода:** синтаксис Ruby/HAML, корневые тесты
- **Unit тесты:** tests/unit/ (Minitest, без БД)
- **Интеграционные:** tests/integration/ (с MySQL)
- **Производительность и аксессибилмность**

### 🔒 **security-advanced.yml** - Продвинутое сканирование
- **GitLeaks:** поиск секретов в истории Git
- **Semgrep:** Static Application Security Testing (SAST)
- **Trivy:** поиск уязвимостей в зависимостях

### 📝 **Структура тестов**
```
tests/unit/           - Модульные тесты (Minitest, без БД)
tests/integration/    - Интеграционные тесты (с MySQL)
test_*.rb            - Специальные тесты для отдельных фич
```
...
### Внесенные изменения в `.github/workflows/security-advanced.yml`:
...
Эти исправления решают основные проблемы с GitHub Actions security scanning и обеспечивают правильную организацию CI/CD пайплайнов без дублирования функциональности.
